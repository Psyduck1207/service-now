...
import 'package:untitled/onlinestore/StoreExplore.dart';
...
class _CreateStoreState extends State<CreateStore> {
  ...
  _addToFirestore() async {
    ...
    FirebaseFirestore.instance.collection('OnlineStore').add(data).then((value) => {
    ...
    Navigator.push(context, MaterialPageRoute(builder:(context)=>StoreExplore()));
  }
