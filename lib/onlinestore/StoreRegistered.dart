...
class StoreExploreView extends StatefulWidget {
  ...
  StoreExploreView({required this.name,required this.price,required this.description,required this.contact, this.image});
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      widget.image != null ? Container(
                          ...
                          child:Image.network("https://m.media-amazon.com/images/I/61tmUVoMcWL.jpg")
                      ),
