...
class JobExploreView extends StatefulWidget {
  JobExploreView({required this.role,required this.description,required this.city,required this.mobile,required this.posts,required this.salary,required this.duration,required this.type});
  final String role,description,city,mobile,posts,salary,duration,type;
